...
(function(root, factory){
    ...
    var AppConfig = {
        ...
        FAILBACK: {
            ...
            IOS: "http://a.app.qq.com/o/simple.jsp?pkgname=com.shellcolr.cosmos"
        },
        APK_INFO: {
    ...
    return {
        ...
        mixinConfig: function(config){
            ...
            AppConfig.targetUrl = config.targetUrl || AppConfig.HOME;
        ...
        loadSchema: function(config){
            ...
            var schemaUrl = this.generateSchema(AppConfig.targetUrl);
            ...
            //     window.location.href = AppConfig.FAILBACK.ANDROID ;//+ "&android_schema=moboo-web://external";// + schemaUrl;
